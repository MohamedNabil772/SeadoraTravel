  ...
  <div class="feedback-page min-h-screen bg-cream text-dark flex flex-col font-sans relative overflow-hidden">
    ...
    <header class="w-full py-6 px-8 md:px-16 border-b border-gold/20 flex justify-between items-center bg-sea-deep/95 backdrop-blur-md relative z-10">
      <router-link to="/" class="flex items-center gap-3 no-underline group">
        <img src="/logo-emblem.png" alt="Seadora Travel" class="w-11 h-11 object-contain drop-shadow-[0_0_8px_rgba(201,168,76,0.3)] group-hover:scale-105 transition-transform" />
        <div class="leading-none">
          <span class="font-serif text-lg font-bold text-white tracking-wide block">SEADORA</span>
          <span class="text-[9px] text-gold tracking-widest uppercase font-semibold mt-0.5 block">Travel · Egypt</span>
        </div>
      </router-link>
